...
{
private:
    string name, roll_no, course, city, email_id, contact_no;
...
void student::insert() // add student details
{
    ...
    file << " " << name << " " << roll_no << " " << course << " " << email_id << " " << contact_no << " " << city << "\n";
    file.close();
}
    ...
    else
    {
        ...
        while (!file.eof())
        {
            if (rollno != roll_no)
                ...
                file1 << " " << name << " " << roll_no << " " << course << " " << email_id << " " << contact_no << " " << city << "\n";
            else
            {
                cout << "\n\t\t\tEnter Name: ";
                cin >> name;
...
int main()
{
   int option;
    ...
    else if(option == 2) // if user chooses to login
    {
